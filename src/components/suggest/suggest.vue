<template lang='jade'>
  Scroll.suggest(:data="result", :pullup="pullup", :beforeScroll="beforeScroll" @scrollToEnd="searchMore" @beforeScroll="listScroll" ref="suggest")
    ul.suggest-list
    ...
    methods: {
      ...
      search() {
        ...
        search(this.query, this.page, this.showSinger, perpage).then((res) => {
          if (res.code === ERR_OK) {
            this.result = this._fmtResult(res.data)
      ...
      searchMore() {
        ...
        search(this.query, this.page, this.showSinger, perpage).then((res) => {
          if (res.code === ERR_OK) {
            this.result = this.result.concat(this._fmtResult(res.data))
            this._checkMore(res.data)
          }
        })
      },
